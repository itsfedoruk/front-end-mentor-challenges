...
For this challenge, I built a mobile-first article preview component with vanilla HTML, CSS, and JS – and adapted the page for a desktop view. To organise styles and practice keeping the code robust and easy to read, I worked with the BEM [(Block-Element-Modifier)](http://getbem.com/introduction/) methodology.

[Check it out!](https://projects.fedoruk.eu/frontend-mentor/04_article-preview-component/) Any feedback – let me know 🙌

In case you'd like to practice the project yourself, scroll down and follow the challenge instructions.

![Design preview for the Article preview component coding challenge](./mock-ups/desktop-preview.jpg)
