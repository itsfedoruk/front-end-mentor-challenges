...
For this challenge, I built a mobile-first social proof page with vanilla HTML and CSS – and adapted the page for a desktop view.

[Check it out!](https://projects.fedoruk.eu/frontend-mentor/03_social-proof-section/) Any feedback – let me know 🙌

In case you'd like to practice the project yourself, scroll down and follow the challenge instructions.

![Design preview for the Social proof section coding challenge](./mock-ups/desktop-preview.jpg)
