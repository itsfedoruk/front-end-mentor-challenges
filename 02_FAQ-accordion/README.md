...
For this challenge, I worked with vanilla HTML, CSS, and Javascript – and adapted the page for mobile and desktop views.

[Check it out!](https://projects.fedoruk.eu/frontend-mentor/02_FAQ-accordion/) Any feedback – let me know 🙌

In case you'd like to practice the project yourself, scroll down and follow the challenge instructions.

![Design preview for the FAQ Accordion Card coding challenge](./mock-ups/desktop-preview.jpg)
